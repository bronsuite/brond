...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*bronutil.Block, error) {
	...
	blocks := make([]*bronutil.Block, 0, 256)
	genesis := bronutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
