...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, brond, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown brond.",
	"stop--result0":  "The string 'brond stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this brond instance) and when such a transaction first appears in a newly-attached block.",
