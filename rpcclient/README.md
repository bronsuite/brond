...
* [btcd Websockets Example](https://github.com/bronsuite/brond/tree/master/rpcclient/examples/btcdwebsockets)
  Connects to a btcd RPC server using TLS-secured websockets, registers for
  block connected and block disconnected notifications, and gets the current
  block count
* [btcwallet Websockets Example](https://github.com/bronsuite/brond/tree/master/rpcclient/examples/btcwalletwebsockets)
