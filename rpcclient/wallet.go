...
func (r FutureAddMultisigAddressResult) Receive() (bronutil.Address, error) {
	...
	return bronutil.DecodeAddress(addr, r.network)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (bronutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (r FutureGetRawChangeAddressResult) Receive() (bronutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (bronutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (r FutureGetAccountAddressResult) Receive() (bronutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (r FutureGetAddressesByAccountResult) Receive() ([]bronutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]bronutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = bronutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
func (r FutureListAccountsResult) Receive() (map[string]bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]bronutil.Amount)
	for k, v := range accounts {
		amount, err := bronutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (r FutureGetBalanceResult) Receive() (bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := bronutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (r FutureGetReceivedByAccountResult) Receive() (bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (r FutureGetReceivedByAddressResult) Receive() (bronutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (r FutureDumpPrivKeyResult) Receive() (*bronutil.WIF, error) {
	...
	return bronutil.DecodeWIF(privKeyWIF)
}
