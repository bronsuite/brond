...
For example (taken from [f3ec130](https://github.com/bronsuite/brond/commit/f3ec13030e4e828869954472cbc51ac36bee5c1d)):
```diff
...
1. `git clone https://github.com/bronsuite/brond.git`
2. `cd d`
...
which roughly follow the format of [previous release notes](https://github.com/bronsuite/brond/releases/tag/v0.20.1-beta).
...
6. Obtain a copy of `btcd`'s source code with `git clone
   https://github.com/bronsuite/brond` and checkout the source code of the
