...
/*
brond is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means brond will work 'out of
...
parsed when brond starts up.  By default, the configuration file is located at
~/.brond/brond.conf on POSIX-style operating systems and %LOCALAPPDATA%\brond\brond.conf
...
Application Options:
  ...
  -d, --debuglevel=           Logging level for all subsystems {trace, debug,
      ...
      --miningaddr=           Add the specified payment address to the list of
                              ...
                              set
      --minrelaytxfee=        The minimum transaction fee in BROND/kB to be
