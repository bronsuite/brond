...
* Download the Conformal public key:
  https://raw.githubusercontent.com/bronsuite/brond/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/bronsuite/brond/releases)
...
```bash
git clone https://github.com/bronsuite/brond $GOPATH/src/github.com/bronsuite/brond
...
* [Using bootstrap.dat](https://github.com/bronsuite/brond/blob/master/docs/configuration.md#using-bootstrapdat)
