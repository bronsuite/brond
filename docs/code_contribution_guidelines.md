...
reason, the brond suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire brond
...
One of the major design goals of all core brond packages is to aim for complete
...
commits](https://github.com/bronsuite/brond/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into brond.
...
Rejoice as you will now be listed as a [contributor](https://github.com/bronsuite/brond/graphs/contributors)!
...
[ISC license](https://github.com/bronsuite/brond/blob/master/LICENSE).  This is
the same license as all of the code in the brond suite.
