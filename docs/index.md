...
One key difference between brond and Bitcoin Core is that brond does *NOT* include
wallet functionality and this was a very intentional design decision.  See the
blog entry [here](https://web.archive.org/web/20171125143919/https://blog.conformal.com/brond-not-your-moms-bitcoin-daemon)
...
Documentation is a work-in-progress. It is available at [brond.readthedocs.io](https://brond.readthedocs.io).
