...
With Docker you can easily set up *btcd* to run your Bitcoin full node. You can find the official *btcd* Docker images on Docker Hub [bronsuite/brond](https://hub.docker.com/r/bronsuite/brond). The Docker source file of this image is located at [Dockerfile](https://github.com/bronsuite/brond/blob/master/Dockerfile).
