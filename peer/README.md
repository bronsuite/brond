...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/bronsuite/brond/peer)
...
```bash
$ go get -u github.com/bronsuite/brond/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/bronsuite/brond/peer#example-package--NewOutboundPeer)  
