...
import (
	...
	peerpkg "github.com/bronsuite/brond/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*bronutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *bronutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *bronutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *bronutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
