...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/bronsuite/brond/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/bronsuite/brond/mining/cpuminer
```
