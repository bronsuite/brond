...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr bronutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*bronutil.Tx, error) {
...
func CreateBlock(prevBlock *bronutil.Block, inclusionTxs []*bronutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr bronutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*bronutil.Block, error) {
	...
	blockTxns := []*bronutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := bronutil.NewBlock(&block)
