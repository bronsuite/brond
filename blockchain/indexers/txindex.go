...
func dbAddTxIndexEntries(dbTx database.Tx, block *bronutil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *bronutil.Block) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block *bronutil.Block,
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block *bronutil.Block,
	stxos []blockchain.SpentTxOut) error {
