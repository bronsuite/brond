...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*bronutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *bronutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *bronutil.Block) error {
