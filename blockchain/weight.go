...
func GetBlockWeight(blk *bronutil.Block) int64 {
...
func GetTransactionWeight(tx *bronutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *bronutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
