...
func (view *UtxoViewpoint) AddTxOut(tx *bronutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *bronutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *bronutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *bronutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *bronutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *bronutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *bronutil.Tx) (*UtxoViewpoint, error) {
